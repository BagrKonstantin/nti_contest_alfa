...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1197, 824)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.tabWidget = QtWidgets.QTabWidget(self.centralwidget)
        self.tabWidget.setGeometry(QtCore.QRect(30, 10, 1051, 721))
        self.tabWidget.setObjectName("tabWidget")
        self.tab = QtWidgets.QWidget()
        self.tab.setObjectName("tab")
        self.frame_greeting = QtWidgets.QFrame(self.tab)
        self.frame_greeting.setGeometry(QtCore.QRect(0, 10, 1011, 661))
        ...
        self.pushButton_change_pass.setGeometry(QtCore.QRect(860, 10, 121, 28))
        self.pushButton_change_pass.setObjectName("pushButton_change_pass")
        self.frame = QtWidgets.QFrame(self.frame_greeting)
        self.frame.setGeometry(QtCore.QRect(20, 70, 981, 601))
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.label_32 = QtWidgets.QLabel(self.frame)
        self.label_32.setGeometry(QtCore.QRect(370, 10, 81, 16))
        self.label_32.setObjectName("label_32")
        self.tableWidget = QtWidgets.QTableWidget(self.frame)
        self.tableWidget.setGeometry(QtCore.QRect(0, 40, 971, 541))
        ...
        self.lineEdit_napravlenie_stud = QtWidgets.QLineEdit(self.frame)
        self.lineEdit_napravlenie_stud.setGeometry(QtCore.QRect(460, 10, 113, 22))
        self.lineEdit_napravlenie_stud.setReadOnly(True)
        self.lineEdit_napravlenie_stud.setObjectName("lineEdit_napravlenie_stud")
        self.pushButton_raspisanie = QtWidgets.QPushButton(self.frame)
        self.pushButton_raspisanie.setGeometry(QtCore.QRect(720, 10, 93, 28))
        self.pushButton_raspisanie.setObjectName("pushButton_raspisanie")
        self.pushButton_dek_and_rek = QtWidgets.QPushButton(self.frame)
        self.pushButton_dek_and_rek.setGeometry(QtCore.QRect(582, 10, 131, 28))
        self.pushButton_dek_and_rek.setObjectName("pushButton_dek_and_rek")
        self.label_30 = QtWidgets.QLabel(self.frame)
        self.label_30.setGeometry(QtCore.QRect(160, 10, 71, 16))
        self.label_30.setObjectName("label_30")
        self.lineEdit_fakultet_stud = QtWidgets.QLineEdit(self.frame)
        self.lineEdit_fakultet_stud.setGeometry(QtCore.QRect(240, 10, 113, 22))
