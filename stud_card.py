...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEdit_group_num = QtWidgets.QLineEdit(self.tab_3)
        self.lineEdit_group_num.setGeometry(QtCore.QRect(120, 160, 113, 22))
        self.lineEdit_group_num.setReadOnly(True)
        self.lineEdit_group_num.setObjectName("lineEdit_group_num")
        ...
        self.pushButton_4.setGeometry(QtCore.QRect(60, 530, 191, 23))
...
"билета и зачетной книжки"))
        ...
        self.pushButton_4.setText(_translate("MainWindow", "Распечатать Студенческий билет"))
